...
public class Stats
{
    ...
    {
        Dictionary<uint, Nohit>.ValueCollection nohits = DataBase.Nohits.Values;
        ...
        var avgPerDay = (float)Math.Round(totalNohits / timeSinceFirst.TotalDays, 2);
        var hoursFootage = (float)Math.Round(totalNohits * 90f / 3600f, 2);
